 ...
 *******************************************************************************/
#ifndef SD_HAL_MPU6050_H_
#define SD_HAL_MPU6050_H_
 ...
 */
/**
 * @defgroup SD_MPU6050 SD_MPU6050
 * @brief MPU6050 API
 * @{
 */

/**
 * @defgroup SD_MPU6050 SD_MPU6050_Macros
...
typedef struct  {
	...
	/*Init*/
	int16_t init_Accelerometer_X; /*!< Accelerometer value X axis */
	int16_t init_Accelerometer_Y; /*!< Accelerometer value Y axis */
	int16_t init_Accelerometer_Z; /*!< Accelerometer value Z axis */
	int16_t init_Gyroscope_X;     /*!< Gyroscope value X axis */
	int16_t init_Gyroscope_Y;     /*!< Gyroscope value Y axis */
	int16_t init_Gyroscope_Z;     /*!< Gyroscope value Z axis */
